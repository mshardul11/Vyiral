...
export class KeywordsRepository extends BaseRepository<KeywordDoc> {
  ...
  mapDoc(id: string, data: DocumentData): KeywordDoc {
    return {
      ...
      seoDifficulty: data.seoDifficulty as number | undefined,
      trendDirection: data.trendDirection as KeywordDoc["trendDirection"],
      contentIntent: data.contentIntent as string | undefined,
      contentFormatRecommendation: data.contentFormatRecommendation as string | undefined,
